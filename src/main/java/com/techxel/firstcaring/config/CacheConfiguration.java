package com.techxel.firstcaring.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.techxel.firstcaring.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.techxel.firstcaring.repository.UserRepository.USERS_BY_EMAIL_CACHE);
