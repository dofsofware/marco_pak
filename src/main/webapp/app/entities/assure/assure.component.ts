...
export class AssureComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.assureService
      ...
      .subscribe(
        (res: HttpResponse<IAssure[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAssures(): void {
    this.eventSubscriber = this.eventManager.subscribe('assureListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAssure[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
