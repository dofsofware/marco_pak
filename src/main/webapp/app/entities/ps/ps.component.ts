...
export class PSComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pSService
      ...
      .subscribe(
        (res: HttpResponse<IPS[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPS(): void {
    this.eventSubscriber = this.eventManager.subscribe('pSListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPS[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
