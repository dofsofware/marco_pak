...
export class PackComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.packService
      ...
      .subscribe(
        (res: HttpResponse<IPack[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPacks(): void {
    this.eventSubscriber = this.eventManager.subscribe('packListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPack[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
