...
export class AssureurComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.assureurService
      ...
      .subscribe(
        (res: HttpResponse<IAssureur[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAssureurs(): void {
    this.eventSubscriber = this.eventManager.subscribe('assureurListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAssureur[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/assureur'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
