...
import { PSComponent } from 'app/entities/ps/ps.component';
import { PSService } from 'app/entities/ps/ps.service';
import { PS } from 'app/shared/model/ps.model';

describe('Component Tests', () => {
  describe('PS Management Component', () => {
    let comp: PSComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pS && comp.pS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
